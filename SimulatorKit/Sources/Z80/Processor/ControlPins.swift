...
public struct ControlPins: OptionSet, Hashable {
...
extension ControlPins {
	...
	/// Whether ``ControlPins/busack-type.property`` is currently active.
	@inlinable
	public var busack: Bool {
		get { !self[.busack] }
		set { self[.busack] = !newValue }
	}

	/// Whether ``ControlPins/busreq-type.property`` is currently active.
	@inlinable
	public var busreq: Bool {
		get { !self[.busreq] }
		set { self[.busreq] = !newValue }
	}
